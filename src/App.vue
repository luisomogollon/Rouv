...
<template>
  <section class="w-full px-8 text-gray-700 bg-slate-500">
    <div
      class="container max-h-full max-w-full flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row"
    >
      <div class="relative flex flex-col md:flex-row">
        ...
        >
          <span
            ...
            >Luiso<span class="text-indigo-600">.</span></span
          >
        </a>
        <nav
        ...
        >
          ...
          <a
            href="#_"
            class="mr-5 font-medium leading-6 text-gray-800 hover:text-gray-900"
            ><RouterLink to="/create">About</RouterLink></a
          >
          <a
            href="#_"
  ...
  <section class="bg-slate-500">
    <div
      class="max-w-screen-xl px-2 py-0 mx-auto space-y-2 overflow-hidden sm:px-6 lg:px-8"
    >
      ...
      <p class="mt-10 text-base leading-10 text-center text-gray-400">
