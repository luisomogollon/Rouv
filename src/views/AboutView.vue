...
<!-- Section 1 -->
<section class="  mx-auto my-auto container  min-h-screen w-full  bg-white pt-7  pb-7 md:pt-20 md:pb-24">
    <div class="  flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-16">

        <!-- Image -->
        <div class="relative w-full max-w-md px-4 mt-5 mb-4 -ml-5 text-center bg-no-repeat bg-contain border-solid md:ml-0 md:mt-0 md:max-w-none lg:mb-0 md:w-1/2 xl:pl-10">
            <img src="https://cdn.devdojo.com/images/december2020/productivity.png" class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0 ">
        </div>

        <!-- Content -->
        <div class="order-first w-full  text-black border-solid md:w-1/2 md:pl-10 md:order-none">
            ...
            <ul class="p-0 m-0 leading-6 border-0 border-gray-300">
                <li class=" relative py-1 pl-0 text-left text-gray-500 border-solid">
    ...
    <div class=" flex flex-col items-center content-center px-8 mx-auto mt-2 leading-6 text-black border-0 border-gray-300 border-solid md:mt-20 xl:mt-0 md:flex-row max-w-7xl lg:px-16">

        <!-- Content -->
        <div class=" w-full text-black border-solid md:w-1/2 md:pl-6 xl:pl-32">
            <h2 class="m-0 text-xl font-semibold leading-tight border-0 border-gray-300 lg:text-3xl md:text-2xl">
                Automated Tasks
            </h2>
